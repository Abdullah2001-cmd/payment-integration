...
const gmailConfig = {
    ...
    secure: false,
    auth: {
        user: 'abdullah.320409@gmail.com',
        pass: 'hbjvvvwoguoekpxo'
    }
};
...
const outlookConfig = {
    ...
    secure: false,
    auth: {
        user: 'info@nerdybuddy.com',
        pass: 'your-outlook-password'
    }
};

// default transport used only for initial verification (gmail)
let defaultTransporter = nodemailer.createTransport(gmailConfig);
...
async function sendEmail(to, template, data) {
    try {
        const transporter = getTransporterForRecipient(to);
        const mailOptions = {
            to,
            ...template(data)
        };
...
app.use(cors({
    origin: [
        'https://mc-rae.vercel.app',
        'https://nerdybuddy-web.vercel.app'
    ],
    credentials: true
}));
